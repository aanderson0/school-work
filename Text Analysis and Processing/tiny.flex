...
({number}*{letter}+{number}*)+                 { return new Token(Token.WORD, yytext(), yyline, yycolumn); }
{number}                  { return new Token(Token.NUMBER, yytext(), yyline, yycolumn); }
("'"+|{letter}+|{number}+)+           { return new Token(Token.APOSTROPHIZED, yytext(), yyline, yycolumn); }
("-"+|{letter}+|{number}+|"'"+)+           { return new Token(Token.HYPHENATED, yytext(), yyline, yycolumn); }
